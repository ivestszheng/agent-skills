<!--
  文件名: chat-sender-example-file-citation.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/chat-sender#文件引用
  场景: 文件引用
  描述: 演示通过 header 插槽展示引用的文件。
  依赖组件: t-chat-sender, t-icon, t-navbar
  关键特性: header插槽, 文件引用展示, 文件图标
-->

# ChatSender 代码演示-文件引用
