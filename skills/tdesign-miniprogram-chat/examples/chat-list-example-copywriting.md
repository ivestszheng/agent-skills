<!--
  文件名: chat-list-example-copywriting.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/chat-list#文案助手
  场景: 文案助手
  描述: 演示附件上传与文案生成场景。
  依赖组件: t-chat-message, t-chat-actionbar, t-chat-sender, t-chat-content, custom-tail, t-toast
  关键特性: 附件上传, markdownProps流式尾标, generic:tail-component
-->
