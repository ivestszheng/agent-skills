<!--
  文件名: chat-list-example-image.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/chat-list#图像生成
  场景: 图像生成
  描述: 演示助手返回多图结果展示。
  依赖组件: t-chat-message, t-chat-actionbar, t-chat-sender, t-chat-content, t-attachments, t-toast
  关键特性: imageview内容类型, t-attachments图片列表, 自定义内容插槽
-->
