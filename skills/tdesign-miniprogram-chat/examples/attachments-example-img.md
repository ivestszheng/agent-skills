<!--
  文件名: attachments-example-img.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/attachments#图片类型
  场景: 图片类型
  描述: 演示图片类型附件的基础展示与交互。
  依赖组件: t-attachments
  关键特性: 图片附件, fileClick/remove/add事件, 图片预览
-->

# Attachments 代码演示-图片类型
