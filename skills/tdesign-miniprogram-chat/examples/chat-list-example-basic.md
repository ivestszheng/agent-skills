<!--
  文件名: chat-list-example-basic.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/chat-list#基础使用
  场景: 基础使用
  描述: 演示如何在 ChatList 中使用基础功能。
  依赖组件: t-chat-message, t-chat-actionbar, t-chat-sender, t-toast
  关键特性: 基础功能, 事件绑定, 自定义样式
-->
