<!--
  文件名: chat-list-example-composition.md
  官方文档：https://tdesign.tencent.com/miniprogram-chat/components/chat-list#%E7%BB%84%E5%90%88%E5%BC%8F%E7%94%A8%E6%B3%95
  场景: 组合式用法
  描述: 演示助手回复包含思考过程和正文两部分，分阶段流式输出。
  依赖组件: t-chat-message, t-chat-actionbar, t-chat-sender, t-chat-content, t-toast
  关键特性: 思考过程, chatContentProps.thinking, 分阶段流式
-->
